...
DATASET_DIR2 = os.path.join("/net/tscratch/people/plgmarbar/", "emodb")
# Ścieżka do folderu z danymi (rozpakowany ZIP)
RAVDESS_DIR = os.path.join("/net/tscratch/people/plgmarbar/emodb", "emodb_audio_only/wav")
CSV_PATH = os.path.join("/net/tscratch/people/plgmarbar/emodb/emodb_audio_only/", "emodb_metadata.csv")
OUTPUT_DIR = os.path.join("/net/tscratch/people/plgmarbar/emodb", "wav2vec2_checkpoints_emodb")
...
# Konwersja Pandas → Huggif laingFace Dataset
...
EMODB_DIR2 = "/net/tscratch/people/plgmarbar/emodb/emodb_audio_only"

train_ds = df_to_hf_dataset(train_df, EMODB_DIR2)
val_ds = df_to_hf_dataset(val_df, EMODB_DIR2)
test_ds = df_to_hf_dataset(test_df, EMODB_DIR2)
